...
import styles from '@/app/ui/vendor/google/sign-in-with-google-button.module.css';

export default function SignInWithGoogleButton(props: any) {
  return (
    <button className={styles["gsi-material-button"]} {...props}>
